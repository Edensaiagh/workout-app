...
const styles = StyleSheet.create({
  ...
  h1: { fontSize: 28, fontWeight: '800', color: COLORS.text, textAlign: 'right' },
  subtitle: { fontSize: 13, color: COLORS.textDim, marginTop: 2, textAlign: 'right' },
  ...
  cardExercisesTitle: { fontSize: 13, color: COLORS.textDim, marginTop: 12, textAlign: 'right' },
  exerciseBullets: { marginTop: 6 },
  exerciseBulletText: { fontSize: 13, color: COLORS.textDim, textAlign: 'right', lineHeight: 19 },
  ...
  metric: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6 },
  ...
  detailTitle: { fontSize: 24, fontWeight: '800', color: COLORS.text, textAlign: 'right' },
  detailSub: { fontSize: 13, color: COLORS.textDim, marginTop: 3, textAlign: 'right' },
  detailStats: { flexDirection: 'row-reverse', paddingHorizontal: 20, paddingVertical: 16 },
  ...
  exName: { fontSize: 16, fontWeight: '700', color: COLORS.text, marginBottom: 10, textAlign: 'right' },
  restBetween: { textAlign: 'center', color: COLORS.textFaint, fontSize: 12, paddingVertical: 3 },
  setRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 10, paddingVertical: 6 },
  setNum: {
    width: 22,
    height: 22,
    borderRadius: 7,
